const delay = 1000;
const siteUrl = "http://localhost:2368/ghost/";
const url = "http://localhost:2368/ghost/#/signin";
const dashboardPage = "http://localhost:2368/ghost/#/dashboard";
const staffPage = "http://localhost:2368/ghost/#/settings/staff";
const memberPage = "http://localhost:2368/ghost/#/members";
