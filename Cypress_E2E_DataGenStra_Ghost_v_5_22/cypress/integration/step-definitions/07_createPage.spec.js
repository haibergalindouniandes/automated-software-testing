...
//Test setup
describe('Create Page with Data Pool A Priori(DPAP)', () => {
    beforeEach(function () {
    ...
    it(`${escenario}_DPAP_SuccessData`, function() {     
        ...
        cy.log(pageToCreate);    
        pages.createPage(emailLogin, pageToCreate.page_title, pageToCreate.page_content, escenario);
    })  
    ...
    it(`${escenario}_DPAP_Failed_Null_Title`, function() {     
        ...
        let pageToCreate = this.pagesData[Utils.getRandomInt(0, this.pagesData.length - 1)];
        cy.log(pageToCreate);    
        pages.createPage(emailLogin, "", pageToCreate.page_content, escenario);
    })  
    ...
    it(`${escenario}_DPAP_Failed_Null_Content`, function() {     
        ...
        let pageToCreate = this.pagesData[Utils.getRandomInt(0, this.pagesData.length - 1)];
        cy.log(pageToCreate);    
        pages.createPage(emailLogin, pageToCreate.page_title, "", escenario);
    })  
    ...
    it(`${escenario}_DPAP_length_Title`, function() {     
        ...
        let pageToCreate = this.pagesData[Utils.getRandomInt(0, this.pagesData.length - 1)];
        cy.log(pageToCreate);    
        pages.createPage(emailLogin, pageToCreate.page_title+pageToCreate.page_content, pageToCreate.page_content2, escenario);
    })  
    ...
    it(`${escenario}_DPAP_special_characters`, function() {     
        ...
        let pageToCreate = this.pagesData[Utils.getRandomInt(0, this.pagesData.length - 1)];
        cy.log(pageToCreate);    
        pages.createPage(emailLogin, pageToCreate.special_chararters+pageToCreate.page_title, pageToCreate.special_chararters+pageToCreate.page_content+pageToCreate.page_content2, escenario);
    })  
...
describe('Create Page With Dynamic DataPool(DDP)', () => {
    ...
    it(`${escenario}_DDP_length_Title`, function() {     
        ...
        let pageToCreate = this.pagesData[Utils.getRandomInt(0, this.pagesData.length - 1)];
        cy.log(pageToCreate);    
        pages.createPage(emailLogin, pageToCreate.page_title+pageToCreate.page_content, pageToCreate.page_content, escenario);
    })  
...
describe('Create Page With FakerData(OFD)', () => {
    ...
    it(`${escenario}_OFD_SuccessData`, function() {     
        ...
        pages.createPage(emailLogin, title, content, escenario);
    })
