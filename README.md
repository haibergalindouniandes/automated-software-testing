...
> Toda la información de la estructura de carpetas, instalación y configuración, ejecución, entre otras, son detalladas en la siguiente wiki.
[Cypress_MonkeyTest_Ghost_v_5_22](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-Cypress_MonkeyTest_Ghost_v_5_22)
...
> Toda la información de la estructura de carpetas, instalación y configuración, ejecución, entre otras, son detalladas en la siguiente wiki.
[RIPuppet_SST_Ghost_v_5_22](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-RIPuppet_SST_Ghost_v_5_22)
...
> Toda la información de las diferentes funcionalidades y escenarios, estructura de carpetas, instalación y configuración, ejecución, ventajas y desventajas del uso de la herramienta, entre otras, son detalladas en la siguiente wiki.
[Kraken_E2E_Ghost_v_5_22](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-Kraken_E2E_Ghost_v_5_22)
...
> Toda la información de las diferentes funcionalidades y escenarios, estructura de carpetas, instalación y configuración, ejecución, ventajas y desventajas del uso de la herramienta, entre otras, son detalladas en la siguiente wiki.
[Kraken_E2E_Ghost_v_3_42](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-Kraken_E2E_Ghost_v_3_42)
...
> Toda la información de las diferentes funcionalidades y escenarios, estructura de carpetas, instalación y configuración, ejecución, ventajas y desventajas del uso de la herramienta, entre otras, son detalladas en la siguiente wiki.
[Cypress_E2E_Ghost_v_5_22](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-Cypress_E2E_Ghost_v_5_22)
...
> Toda la información de las diferentes funcionalidades y escenarios, estructura de carpetas, instalación y configuración, ejecución, ventajas y desventajas del uso de la herramienta, entre otras, son detalladas en la siguiente wiki.
[Cypress_E2E_Ghost_v_3_42](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-Cypress_E2E_Ghost_v_3_42)
...
> Toda la información de las diferentes funcionalidades y escenarios, estructura de carpetas, instalación y configuración, ejecución, ventajas y desventajas del uso de la herramienta, entre otras, son detalladas en la siguiente wiki.
[Cypress_E2E_DataGenStra_Ghost_v_5_22](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-Cypress_E2E_DataGenStra_Ghost_v_5_22)
...
> Toda la información de la estructura de carpetas, instalación y configuración, ejecución, ventajas y desventajas del uso de la herramienta, entre otras, son detalladas en la siguiente wiki.
[VRT_ResembleJS](https://github.com/haibergalindouniandes/automated-software-testing/wiki/Proyecto-VRT_ResembleJS)
